...
Clicking the icon immediately swaps the triage UI for a generic "Flower Decoration Blog."

To prevent discovery if a third party enters the room or looks at the screen.

- **2. Time-Sensitive Triage UI**

A dynamic slider allows users to input how many hours have passed since an incident.

If the input is ≤ 72 hours, the UI triggers a CRITICAL alert, highlighting the window for PEP (HIV prevention) and J88 forensic evidence collection.
